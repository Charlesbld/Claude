...
TABLES: dict[str, TableSpec] = {
    ...
    "param_aht": _t("param_aht", "AHT par type de tâche (B1)", ["task_type_id"],
                    ["task_type_id"], ["aht_seconds"], editable=True, group="Paramètres",
                    note="Temps de traitement moyen, simplifié au grain task_type."),
    "service_params": _t("service_params", "Objectifs de service / Erlang C (B4)", ["level"],
                         ["level"], ["sl_target", "sl_seconds", "shrinkage", "max_occupancy"],
